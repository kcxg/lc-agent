<template>
  <div class="admin-page">
    ...
    <!-- Create user dialog -->
    <el-dialog v-model="createVisible" title="创建用户" width="420px" :close-on-click-modal="false" append-to-body align-center>
    ...
    <el-dialog v-model="passwordVisible" title="生成的密码" width="420px" :close-on-click-modal="false" append-to-body align-center>
