<template>
  ...
  <el-dialog v-model="deleteDialogVisible" title="删除会话" width="400px" :close-on-click-modal="false" append-to-body align-center>
    <p>确认删除该会话吗？</p>
    <template #footer>
  ...
  <el-dialog v-model="renameDialogVisible" title="重命名会话" width="400px" :close-on-click-modal="false" append-to-body align-center @opened="onRenameDialogOpened">
